...
// used for modulo operation of double value
#include <cmath>
...
class Image : public cs225::PNG {
  public:
    ...
    **/
    ...
    Image& fillSticker(const Image& sticker, unsigned int x_start, unsigned int y_start);
    void resizeHelper(unsigned int newWidth, unsigned int newHeight, unsigned int off_x, unsigned int off_y);
};
