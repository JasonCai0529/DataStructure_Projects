...
std::vector<int> MYFUNCTION(const std::vector<int>& input, int val) {
    heap<int> h;
    for (int v : input) {
        h.insert(v);
    }
...
int main(int argc, const char** argv)
{
    ...
    std::vector<int> test = {2, 3, 4, 5, 1, 4, 7, 2, 6, 7};
    std::vector<int> out = MYFUNCTION(test, 4);
    for (int value: out) {
