...
TEST_CASE("Illini I - FloodFilledImage - DFS", "[weight=3][part=2][timeout=15000]") {
...
TEST_CASE("Illini I - FloodFilledImage - BFS", "[weight=3][part=2][timeout=15000]") {
  PNG png;      png.readFromFile("../data/i.png");
  PNG expected; expected.readFromFile("../data/i-rainbow-bfs.png");
  PNG expected2; expected2.readFromFile("../data/i-rainbow-bfs-2.png");
  
  FloodFilledImage image(png);
  Traversals::ImageTraversal bfs(png, Point(40, 40), 0.05, {
...
TEST_CASE("Lantern - FloodFilledImage - BFS", "[weight=3][part=2]") {
  ...
  FloodFilledImage image(png);
  Traversals::ImageTraversal bfs(png, Point(40, 40), 0.5, {
    Traversals::bfs_add, Traversals::bfs_pop, Traversals::bfs_peek
  });
...
TEST_CASE("PacMan - FloodFilledImage - DFS", "[weight=3][part=2][valgrind][timeout=45000]") {
  ...
  FloodFilledImage image(png);
  Traversals::ImageTraversal dfs(png, Point(100, 50), 0.2, {
    Traversals::dfs_add, Traversals::dfs_pop, Traversals::dfs_peek
  });
