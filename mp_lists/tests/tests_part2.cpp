...
TEST_CASE("List::merge", "[timeout=15000][weight=10][part=2][valgrind]") {
  PNG im1;       im1.readFromFile("../data/merge1.png");
  PNG im2;       im2.readFromFile("../data/merge2.png");
  PNG expected;  expected.readFromFile("../data/expected-merge.png");
...
TEST_CASE("List::sort #1", "[weight=5][part=2]") {
  PNG expected;  expected.readFromFile("../data/expected-sort_1.png");

  srand(225);

  BlockPNG b;
  b.readFromFile("../data/alma.png");
...
TEST_CASE("List::sort #2", "[weight=5][part=2]") {
  PNG expected;  expected.readFromFile("../data/expected-sort_2.png");
