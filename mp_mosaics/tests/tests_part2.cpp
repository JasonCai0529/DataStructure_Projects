...
TEST_CASE("Creates a basic MosaicCanvas (gridtest)", "[weight=5][part=2]") {
  ...
  PNG sourcePNG;
  sourcePNG.readFromFile("../data/gridtest.png");
  ...
  PNG expected;  expected.readFromFile("../data/gridtest-expected.png");
...
TEST_CASE("Creates a basic MosaicCanvas with pitch black (uofi-bw)", "[weight=5][part=2][timeout=12000]") {
  // Read `tests/gridtest.png` from disk
  PNG sourcePNG;
  sourcePNG.readFromFile("../data/uofi-bw.png");
  ...
  PNG actual = canvas->drawMosaic(10);
  PNG expected;  expected.readFromFile("../data/uofi-bw-expected.png");
